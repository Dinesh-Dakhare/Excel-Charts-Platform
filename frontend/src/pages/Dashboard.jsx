...
const Dashboard = () => {
  ...
  return (
    <div className='ml-65 overflow-x-hidden px-4 h-screen'>
      {/* user custome name */}
      ...
      <div className='w-full   '>
        ...
        <div className='flex justify-start items-center py-6 space-x-10'>
          <div className='bg-white/70 group hover:text-black font-medium text-gray-400 text-lg backdrop-blur-sm rounded-xl shadow-md border border-white/20 p-6 flex items-center justify-center gap-3 cursor-pointer hover:scale-105 transition-all ease-in-out duration-150'>
            <FaCloudUploadAlt className='size-12 text-gray-400 mx-auto group-hover:text-blue-600 ' />
            upload file
          </div>
          <div className='bg-white/70 cursor-pointer  group hover:text-black font-medium text-gray-400 text-lg backdrop-blur-sm rounded-xl shadow-md border border-white/20 p-6 flex items-center justify-center gap-3  hover:scale-105 transition-all ease-in-out duration-150'>
            <RiLockPasswordFill className='size-12 text-gray-400 mx-auto group-hover:text-black' />
            change password
          </div>
          <div className='bg-white/70 cursor-pointer  group hover:text-black font-medium text-gray-400 text-lg backdrop-blur-sm rounded-xl shadow-md border border-white/20 p-6 flex items-center justify-center gap-3  hover:scale-105 transition-all ease-in-out duration-150'>
            <FaFileExcel className='size-12 text-gray-400 mx-auto group-hover:text-green-600' />
            Excel to Summary
          </div>
        </div>
      </div>
