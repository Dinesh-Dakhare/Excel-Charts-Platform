...
try {
  const res = await axios.post(
    'http://localhost:5000/api/v1/ai/generate-summary',{chartData:excelData},
  )
  if(res.status === 200){
  ...
  return (
    <div className='lg:ml-65 p-4 mt-10 overflow-x-hidden '>
      ...
      <div className='flex items-center justify-center mt-20 w-full'>
        <Aisummary getSummary={generateaisummary} summary={summary} copyToClipboard={copyToClipboard} copied={copied} />
      </div>
    </div>
  )
}
